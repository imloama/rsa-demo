...
public class RSAUtil {
	 ...
	 * rsap = (RSAPublicKey) RSAUtil.generateKeyPair().getPublic(); String test
	 * = "hello world"; byte[] en_test = encrypt(getKeyPair().getPublic(),
	 * test.getBytes()); byte[] de_test = decrypt(getKeyPair().getPrivate(),
	 * en_test); System.out.println(new String(de_test)); }
	 */
